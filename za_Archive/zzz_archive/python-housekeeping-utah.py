# -*- coding: utf-8 -*-
"""
python-housekeeping-utah_2016-02-26.py , Built on Spyder for Python 2.7
...
winFlatDirStr = 'C:\Users\James Watson\Documents\Python Scripts'

containerDir = os_path.dirname(__file__)
print containerDir
print os_path.isdir(winFlatDirStr)